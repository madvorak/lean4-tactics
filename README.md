...
| <code>aesop?</code>                                         | try to solve the goal using magic and show what kind of magic was used (usually produces unreadable output but the names of relevant lemmas are there)                                                                             <tr></tr>|
| <code>grind</code>                                          | try to solve the goal using dark magic                                                                                                                                                                                             <tr></tr>|
