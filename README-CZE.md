...
| <code>linarith</code>                                       | dokaž cíl pomocí lineární kombinace předpokladů (zahrnuje argumentaci z tranzitivity (ne)rovností)                                                                                                                                 <tr></tr>|
...
| <code>exact?</code>                                         | najdi v knihovně (navíc s využitím lokálního kontextu) lemma, které uzavře cíl                                                                                                                                                     <tr></tr>|
| <code>apply?</code>                                         | najdi v knihovně lemmata, která dokážou zredukovat cíl na jiné cíle                                                                                                                                                                <tr></tr>|
| <code>aesop</code>                                          | zkus dokázat cíl pomocí bílé magie                                                                                                                                                                                                 <tr></tr>|
| <code>grind</code>                                          | zkus dokázat cíl pomocí černé magie                                                                                                                                                                                                <tr></tr>|
